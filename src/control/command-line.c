...
//////////////////////////////////////////////////////
/*        all functions */
static void Arg_setAssert (int b)
{
  Assert_flag = b;
}  

static void Arg_setBuffer (int i)
{
...
static void Arg_setExpert(int b)
{
  Control_expert = b? EXPERT_EXPERT: EXPERT_NORMAL;
}

static void Arg_setJpg(int b)
{
  Control_jpg = b;
}

static void Arg_setLabelInfo(int b)
{
  Control_labelInfo = b;
} 
