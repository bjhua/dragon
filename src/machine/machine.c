...
S Machine_Stm_new_newArray (Id_t dest
                            , Atype_t type
                            , O size)
{
  S s;
...
S Machine_Stm_Runtime_class (Id_t dest
                             , int index
                             , int size
                             , Id_t fname)
{
...
S Machine_Stm_Runtime_array (Id_t dest
                             , int isPtr
                             , O size
                             , int scale
                             , Id_t fname)
...
File_t Machine_Stm_print (File_t file, S s)
{
  ...
  case MACHINE_STM_NEW_ARRAY:{
    ...
    fprintf (file, "%s", " = new ");
    fprintf (file, "%s"
             , Atype_toString (s->u.newArray.ty));
    fprintf (file, "%s", "[");
...
T Machine_Transfer_new_call (Id_t dest
                             , Id_t f
                             , List_t args
                             , Label_t leave
                             , Label_t normal)
...
T Machine_Transfer_new_callnoassign (Id_t f
                                     , List_t args
                                     , Label_t leave
                                     , Label_t normal)
{
...
File_t Machine_Transfer_print (File_t file, T t)
{
  ...
  case MACHINE_TRANS_CALL:
    ...
    List_print (t->u.call.args
                , ", "
                , file
                , (Poly_tyListPrint)Machine_Operand_print);
    fprintf (file, "%s", ");");
    fprintf (file, "goto %s"
...
/////////////////////////////////////////////////////
/* function */
F Machine_Fun_new (Atype_t type, Id_t name, List_t args
...
File_t Machine_Fun_print (File_t file, F f)
{
  ...
  List_foldl (f->blocks
              , file
              , (Poly_tyFold)Machine_Block_print);
...
/////////////////////////////////////////////////////
// frame info
I Machine_FrameInfo_new (List_t offsets
                         , List_t decOffsets
                         , int size)
{
  I p;
...
///////////////////////////////////////////////////////
// program
P Machine_Prog_new (List_t strings
                    , List_t frameInfo
                    , List_t layoutInfo
                    , List_t classes
                    , List_t funcs)
...
File_t Machine_Prog_print (File_t file, P x)
{
  ...
  fprintf (file, "%s"
           , "///////////////////////////strings:\n");  
  List_foldl (x->strings
              , file
              , (Poly_tyFold)Machine_Str_print);
  fprintf (file, "%s", "\n");
