...
S Machine_Stm_new_newClass (Id_t dest
                            , Id_t className);
...
S Machine_Stm_Runtime_class (Id_t dest
                             ...
                             , int size
                             , Id_t fname);
S Machine_Stm_Runtime_array (Id_t
                             , int isPtr
                             , O size
                             , int scale
                             , Id_t fname);
...
T Machine_Transfer_new_call (Id_t dest
                             ...
                             , Label_t leave
                             , Label_t normal);
T Machine_Transfer_new_callnoassign (Id_t name
                                     , List_t args
                                     , Label_t leave
                                     , Label_t normal);
...
F Machine_Fun_new (Atype_t type,  Id_t name
                   , List_t args, List_t decs
                   , List_t blocks, Id_t retId
