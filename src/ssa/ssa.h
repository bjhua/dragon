...
int Ssa_Stm_PhiArg_equals (Ssa_Stm_PhiArg_t
                           , Ssa_Stm_PhiArg_t);
...
S Ssa_Stm_new_bop (Id_t dest, O left, 
...
T Ssa_Transfer_new_call (Id_t dest
                         ...
                         , Label_t leave
                         , Label_t normal);
// whether or not this transfer can jump to label "l"
...
// whether or not this block can jump to label "l"
...
B Ssa_Block_renameUseDefNoPhiUse (B
                                  , Id_t (*use)(Id_t)
                                  , Id_t (*def)(Id_t));
...
F Ssa_Fun_new (Atype_t, Id_t, List_t, List_t, List_t,
               Id_t retId, Label_t, Label_t);
